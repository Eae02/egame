...
find_library(SPIRV_TOOLS_LIBRARY NAMES libSPIRV-Tools.a SPIRV-Tools PATHS ${GLSLANG_LIB_SEARCH_PATH})
find_library(SPIRV_TOOLS_LIBRARY_DEBUG NAMES libSPIRV-Toolsd.a SPIRV-Toolsd libSPIRV-Tools.a SPIRV-Tools PATHS ${GLSLANG_LIB_SEARCH_PATH})
find_library(SPIRV_OPT_LIBRARY NAMES libSPIRV-Tools-opt.a SPIRV-Tools-opt PATHS ${GLSLANG_LIB_SEARCH_PATH})
find_library(SPIRV_OPT_LIBRARY_DEBUG NAMES libSPIRV-Tools-optd.a SPIRV-Tools-optd libSPIRV-Tools-opt.a SPIRV-Tools-opt PATHS ${GLSLANG_LIB_SEARCH_PATH})
find_library(SPIRV_REMAPPER_LIBRARY NAMES libSPVRemapper.a SPVRemapper PATHS ${GLSLANG_LIB_SEARCH_PATH})
find_library(SPIRV_REMAPPER_LIBRARY_DEBUG NAMES libSPVRemapperd.a SPVRemapperd libSPVRemapper.a SPVRemapper PATHS ${GLSLANG_LIB_SEARCH_PATH})
...
if (GLSLANG_FOUND)
	...
	set_target_properties(GLSLang::SpirVTools PROPERTIES
		...
		INTERFACE_LINK_LIBRARIES "GLSLang::SpirVToolsOpt"
	)
	...
	set_target_properties(GLSLang::GLSLang PROPERTIES
		...
		INTERFACE_LINK_LIBRARIES "GLSLang::OGLCompiler;GLSLang::OSDependent;GLSLang::SpirVTools;GLSLang::SpirVRemapper;GLSLang::SpirV;GLSLang::HLSL"
	)
endif()
