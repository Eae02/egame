...
Button TranslateSDLControllerButton(int button)
{
	...
	case SDL_CONTROLLER_BUTTON_A:
		return Button::CtrlrA;
	case SDL_CONTROLLER_BUTTON_B:
		return Button::CtrlrB;
	case SDL_CONTROLLER_BUTTON_X:
		return Button::CtrlrX;
	case SDL_CONTROLLER_BUTTON_Y:
		return Button::CtrlrY;
	case SDL_CONTROLLER_BUTTON_BACK:
		return Button::CtrlrBack;
	case SDL_CONTROLLER_BUTTON_GUIDE:
		return Button::CtrlrGuide;
	case SDL_CONTROLLER_BUTTON_START:
		return Button::CtrlrStart;
	case SDL_CONTROLLER_BUTTON_LEFTSTICK:
		return Button::CtrlrLeftStick;
	case SDL_CONTROLLER_BUTTON_RIGHTSTICK:
		return Button::CtrlrRightStick;
	case SDL_CONTROLLER_BUTTON_LEFTSHOULDER:
		return Button::CtrlrLeftShoulder;
	case SDL_CONTROLLER_BUTTON_RIGHTSHOULDER:
		return Button::CtrlrRightShoulder;
	case SDL_CONTROLLER_BUTTON_DPAD_UP:
		return Button::CtrlrDPadUp;
	case SDL_CONTROLLER_BUTTON_DPAD_DOWN:
		return Button::CtrlrDPadDown;
	case SDL_CONTROLLER_BUTTON_DPAD_LEFT:
		return Button::CtrlrDPadLeft;
	case SDL_CONTROLLER_BUTTON_DPAD_RIGHT:
		return Button::CtrlrDPadRight;
	default:
		return Button::Unknown;
	}
}
...
Button TranslateSDLMouseButton(int button)
{
	...
	case SDL_BUTTON_X1:
		return Button::MouseSide1;
	case SDL_BUTTON_X2:
		return Button::MouseSide2;
	default:
		return Button::Unknown;
	}
}
