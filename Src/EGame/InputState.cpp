...
std::string_view ButtonDisplayName(Button button)
{
	switch (button)
	{
	case Button::MouseLeft: return "Mouse Left";
	case Button::MouseRight: return "Mouse Right";
	case Button::MouseMiddle: return "Mouse Middle";
	case Button::MouseSide1: return "Mouse Side 1";
	case Button::MouseSide2: return "Mouse Side 2";
	case Button::CtrlrA: return "A";
	case Button::CtrlrB: return "B";
	case Button::CtrlrX: return "X";
	case Button::CtrlrY: return "Y";
	case Button::CtrlrBack: return "Back";
	case Button::CtrlrGuide: return "Guide";
	case Button::CtrlrStart: return "Start";
	case Button::CtrlrLeftStick: return "Left Stick";
	case Button::CtrlrRightStick: return "Right Stick";
	case Button::CtrlrLeftShoulder: return "Left Shoulder";
	case Button::CtrlrRightShoulder: return "Right Shoulder";
	case Button::CtrlrDPadUp: return "DPad Up";
	case Button::CtrlrDPadDown: return "DPad Down";
	case Button::CtrlrDPadLeft: return "DPad Left";
	case Button::CtrlrDPadRight: return "DPad Right";
	case Button::LeftShift: return "Left Shift";
	case Button::RightShift: return "Right Shift";
	case Button::LeftControl: return "Left Control";
	case Button::RightControl: return "Right Control";
	case Button::LeftAlt: return "Left Alt";
	case Button::RightAlt: return "Right Alt";
	case Button::Escape: return "Escape";
	case Button::Enter: return "Enter";
	case Button::Space: return "Space";
	case Button::Tab: return "Tab";
	case Button::Backspace: return "Backspace";
	case Button::LeftArrow: return "Left Arrow Key";
	...
	case Button::F1: return "F1";
	case Button::F2: return "F2";
	case Button::F3: return "F3";
	case Button::F4: return "F4";
	case Button::F5: return "F5";
	case Button::F6: return "F6";
	case Button::F7: return "F7";
	case Button::F8: return "F8";
	case Button::F9: return "F9";
	case Button::F10: return "F10";
	case Button::F11: return "F11";
	case Button::F12: return "F12";
	case Button::F13: return "F13";
	case Button::F14: return "F14";
	case Button::F15: return "F15";
	case Button::F16: return "F16";
	case Button::F17: return "F17";
	case Button::F18: return "F18";
	case Button::F19: return "F19";
	case Button::F20: return "F20";
	case Button::F21: return "F21";
	case Button::F22: return "F22";
	case Button::F23: return "F23";
	case Button::F24: return "F24";
...
#ifdef __EMSCRIPTEN__
	if (relMouseMode)
		emscripten_request_pointerlock(EMSCRIPTEN_EVENT_TARGET_WINDOW, true);
	else
