...
public:
	...
	T& operator[](std::pair<size_t, size_t> idx) const { return m_data[ToIndex(idx.first, idx.second)]; }
...
private:
	size_t ToIndex(size_t x, size_t y) const { return x * m_colStride + y * m_rowStride; }
