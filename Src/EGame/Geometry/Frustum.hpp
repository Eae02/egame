...
public:
	...
	inline void SetEnableZCheck(bool value) { m_enableZCheck = value; }
	inline bool EnableZCheck() const { return m_enableZCheck; }

	const Plane& GetPlane(int i) const { return m_planes[i]; }
