...
using CompletionProviderCallback =
	std::function<void(std::span<const std::string_view> prevWords, CompletionsList& list)>;
...
public:
	...
	void NewLine() { m_pendingLines.emplace_back(); }
