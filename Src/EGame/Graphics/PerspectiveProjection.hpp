...
namespace eg
{
	...
	public:
		PerspectiveProjection()
			: m_fieldOfViewRad(HALF_PI * 0.9f), m_zNear(0.1f), m_zFar(1000.0f), m_aspectRatio(1.0f) { }
		...
		float FieldOfViewRad() const
		{
			return m_fieldOfViewRad;
		}
		
		float FieldOfViewDeg() const
		{
			return glm::degrees(m_fieldOfViewRad);
		}
