...
XM_ABSCALLBACK(CopyBufferToTexture, void, (CommandContextHandle ctx, TextureHandle handle, const TextureRange& range, BufferHandle buffer, const TextureBufferCopyLayout& copyLayout))
XM_ABSCALLBACK(CopyTextureToBuffer, void, (CommandContextHandle ctx, TextureHandle handle, const TextureRange& range, BufferHandle buffer, const TextureBufferCopyLayout& copyLayout))
...
XM_ABSCALLBACK(BindSampler, void, (CommandContextHandle ctx, SamplerHandle sampler, uint32_t set, uint32_t binding))
XM_ABSCALLBACK(BindTexture, void, (CommandContextHandle ctx, TextureViewHandle textureView, uint32_t set, uint32_t binding))
...
XM_ABSCALLBACK(GetTextureView, TextureViewHandle, (TextureHandle texture, std::optional<TextureViewType> viewType, const TextureSubresource& subresource, Format format))
...
XM_ABSCALLBACK(BindSamplerDS, void, (SamplerHandle sampler, DescriptorSetHandle set, uint32_t binding))
XM_ABSCALLBACK(BindTextureDS, void, (TextureViewHandle textureView, DescriptorSetHandle set, uint32_t binding, eg::TextureUsage usage))
