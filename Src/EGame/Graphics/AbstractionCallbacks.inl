...
XM_ABSCALLBACK(BindTexture, void, (CommandContextHandle ctx, TextureHandle texture, SamplerHandle sampler, uint32_t set, uint32_t binding))
XM_ABSCALLBACK(ClearColorTexture, void, (CommandContextHandle ctx, TextureHandle texture, uint32_t mipLevel, const Color& color))

XM_ABSCALLBACK(CreateDescriptorSet, DescriptorSetHandle, (PipelineHandle pipeline, uint32_t set))
XM_ABSCALLBACK(DestroyDescriptorSet, void, (DescriptorSetHandle set))
XM_ABSCALLBACK(BindTextureDS, void, (TextureHandle texture, SamplerHandle sampler, DescriptorSetHandle set, uint32_t binding))
...
XM_ABSCALLBACK(BindDescriptorSet, void, (CommandContextHandle ctx, DescriptorSetHandle handle))
