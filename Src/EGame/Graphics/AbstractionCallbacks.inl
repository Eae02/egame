...
XM_ABSCALLBACK(BindTexture, void, (CommandContextHandle ctx, TextureHandle texture, SamplerHandle sampler, uint32_t set, uint32_t binding, const TextureSubresource& subresource, TextureBindFlags flags, Format differentFormat))
...
XM_ABSCALLBACK(BindTextureDS, void, (TextureHandle texture, SamplerHandle sampler, DescriptorSetHandle set, uint32_t binding, const TextureSubresource& subresource, TextureBindFlags flags, Format differentFormat))
