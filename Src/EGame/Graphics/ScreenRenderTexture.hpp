...
public:
	...
	void Invalidate() { m_texture = {}; }

	TextureHandle GetTexture() const { return m_texture.handle; }

	FramebufferHandle GetFramebuffer(
		ScreenRenderTexture* depthTexture = nullptr, std::span<ScreenRenderTexture*> otherColorTextures = {});
