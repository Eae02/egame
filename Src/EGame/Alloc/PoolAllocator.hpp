...
public:
	...
	public:
		inline FindAvailableResult() : m_firstElement(0), m_block(nullptr) {}

		inline bool Found() const { return m_block != nullptr; }

		inline uint64_t GetFirstElement() const { return m_firstElement + m_padding; }
