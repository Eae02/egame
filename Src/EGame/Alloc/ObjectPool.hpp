...
public:
	...
	ObjectPool(ObjectPool&& other) : m_firstPage(other.m_firstPage) { other.m_firstPage = nullptr; }
...
private:
	inline static size_t InUseMask(size_t i) { return static_cast<size_t>(1) << static_cast<size_t>(i % 8); }
