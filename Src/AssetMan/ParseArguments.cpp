...
ParsedArguments ParseArguments(int argc, char** argv)
{
	...
	argumentHandlers["o"] = [&](std::string_view nextArg) { parsed.outputFileName = nextArg; };
	argumentHandlers["r"] = [&](std::string_view nextArg) { parsed.removeByName.emplace_back(nextArg); };
